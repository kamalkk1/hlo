...
function Card (props) {
 ...
 <div className="col-lg-4">
     <div className="card mb-5 mb-lg-0">
         ...
         <h5 class="card-title text-uppercase text-center">{props.data.plan}</h5>             {/* plan is title of card */}
         <p class="card-bill text-muted text-center">{props.data.bill}</p>  {/* bill is title of card */}
         <hr/>
         <ul className="fa-ul">
             {
 ...
 <button href="#" className="btn btn-block btn-primary text-uppercase">Get Started</button>
         </div>
     </div>
 </div>
    </>
